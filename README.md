...
> 本项目是一个循序渐进的实战过程记录，旨在从零开始实现一个类似 OpenClaw 的个人 AI 助手。
...
本项目避开流于表面的低代码平台（如 Dify/Coze）和langchain等AI框架封装，追求以最必要的小规模代码量来实践个人AI助理Harness架构关键功能，展现AI Native原生架构设计和应用开发过程，适合**具备编程基础的工程师**探究AI系统的实现本质。

每个章节包含：
- **技术文档** —— 概念讲解 + 实现过程
- **完整代码** —— 可运行、可对比、可扩展 (ts和golang)
